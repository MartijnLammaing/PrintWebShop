		...
		function start_pirobox() {
			...
			$(piro_gallery).each(function(array) {
					...
					item.bind('click',function(c) {
						...
						caption.html('<p>'+ descr+'<em class="number">' + number + '</em><a href='+ this_url +' class="link_to" target="_blank" title="Open Image in a new window"></a></p><img src=\"img/logoico.png\" style="width: 20px; margin-left: 50%;margin-top: 5px; margin-bottom: 1px;"/>');
						}
						if(item.is('.last')){
